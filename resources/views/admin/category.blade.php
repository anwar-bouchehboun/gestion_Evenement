...
@section('content')
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-8 gap-6 mb-6 pt-6">
                <div
                    ...
                    <div class="rounded-t mb-0 px-0 border-0">
                        <button id="ouvrirPopup"  class="w-20 px-4 py-2 mx-2 mt-4 text-white bg-[#387ADF] rounded-md  ">Add</button>
                        ...
                        <div id="popup"
                            ...
                            <div class="max-w-md p-8 mx-3 bg-white rounded shadow-md">
                                ...
                                <form action="" method="post">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="specialite" class="block mb-2 font-medium text-gray-700">Categorie  :</label>
                            ...
                            1
                              ...
                              <td class="px-6 py-4 flex">
                                ...
                                <form id="deleteForm" action="#" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette spécialité ?')" class="text-red-500 hover:text-red-700">  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-red-500 hover:fill-red-700" viewBox="0 0 24 24">
                                        <path
